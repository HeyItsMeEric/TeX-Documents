...
\usepackage[letterpaper, margin=1in, top=-0.75in]{geometry}
...
%for creating more than 1 new line (if you want blank lines) then use \vspace{5mm} %5mm vertical space (5mm for each line)
